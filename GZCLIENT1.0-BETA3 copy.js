...
button4.textContent = "Get Screens";
button4.style.width = "175px";
button4.style.height = "30px";
button4.style.marginTop = "6px";
...
function dragElement(elmnt) {
  ...
  optionsArray.forEach(option => {
    console.log(option.value); // or option.text for the display text
    array[arraycount] = option.value;
    arraycount += 1;
  });
